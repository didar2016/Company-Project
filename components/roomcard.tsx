      ...
      >
        ...
        >
          <div className="flex flex-row gap-1 sm:gap-2 justify-start">
            <div className="bg-[#00B3DD] text-white w-6 h-6 sm:w-7 sm:h-7 md:w-5 md:h-5 lg:w-9 lg:h-9 xl:h-8 xl:w-8 rounded-full flex items-center justify-center">
              <Maximize2 className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-2.5 md:h-2.5 lg:w-5 lg:h-5" />
            </div>
            <div
